export const translations = {
  tr: {
    ...
    nav: { kpis: 'Genel Bakış', experience: 'Deneyim', skills: 'Yetenekler', projects: 'Projeler', education: 'Eğitim', certificates: 'Sertifikalar' },
    kpis: { hotels: '6+', languages: '3', projects: '10+', automation: '80%' },
    kpis_full: { hotels: 'Yönetilen Otel', languages: 'Konuşulan Dil', projects: 'AI & Web Projeleri', automation: 'Süreç Otomasyonu' },
    experience: {
      title: 'Deneyim',
      neu: {
      ...
      saribekir: {
        ...
        tasks: ['Ambalaj üretim hatlarında makine operasyonlarını yönetti ve verimliliği denetledi.']
      },
      bmw: {
    ...
    skills: {
     ...
     projects: {
      ...
      items: [
        ...
        { name: 'ICALT 2024 Kongre Yönetimi', description: 'Dorana Turizm işbirliğiyle uluslararası bir konferansın planlanması ve koordinasyonu.', link: '/projeler/icalt', tags: ['Event Management', 'Logistics'] },
  ...
  en: {
    ...
    nav: { kpis: 'Overview', experience: 'Experience', skills: 'Skills', projects: 'Projects', education: 'Education', certificates: 'Certificates' },
    kpis: { hotels: '6+', languages: '3', projects: '10+', automation: '80%' },
    kpis_full: { hotels: 'Hotels Managed', languages: 'Languages Spoken', projects: 'AI & Web Projects', automation: 'Process Automation' },
    experience: {
      title: 'Experience',
      neu: {
    ...
    projects: {
      ...
      items: [
        ...
        { name: 'ICALT 2024 Congress Management', description: 'Planned and coordinated an international conference in collaboration with Dorana Tourism.', link: '/projeler/icalt', tags: ['Event Management', 'Logistics'] },
