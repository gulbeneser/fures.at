...
import furesLogo from 'figma:asset/693040ea724c08bc4668b4031b8d5563727ec0fb.png';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link to="/" onClick={closeMenu}>
              <img src={furesLogo} alt="Fures Tech" className="h-8 w-auto transition-transform hover:scale-110 duration-300" />
            </Link>
          </div>
