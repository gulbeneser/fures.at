...
const translations = {
  tr: {
    ...
    'seo.common.keywords': 'kktc web tasarım, kktc web tasarım ajansı, kktc sosyal medya yönetimi, kktc ai tasarım, kktc yapay zeka otomasyon, kktc ürün web sitesi, kktc tanıtım web sitesi, kktc otel web sitesi, kktc logo tasarımı, kktc otomasyon tasarımı, kktc ürün satış web sitesi, girne web tasarım, lefkoşa web tasarım, gazimağusa web tasarım, mağusa web tasarım, kuzey kıbrıs yapay zeka çözümleri, kıbrıs dijital ajans, kıbrıs seo ajansı',
    'seo.organization.description': 'Fures Tech, Gazimağusa merkezli çok dilli web tasarım, AI tasarım, yapay zekâ otomasyon ve büyüme ajansıdır. KKTC web tasarım ajansı olarak Girne, Lefkoşa ve Gazimağusa'da oteller, turizm işletmeleri, ürün markaları ve hizmet şirketleri için ürün web siteleri, tanıtım web siteleri, otel web sitesi oluşturma ve otomasyon tasarımı projeleri geliştiriyoruz.',
    'seo.home.title': 'Fures Tech | Kuzey Kıbrıs Web Tasarım, Yapay Zekâ ve Sosyal Medya Ajansı',
    'seo.home.description': 'Fures Tech, Girne, Lefkoşa ve Gazimağusa\'daki işletmeler için KKTC web tasarım, sosyal medya yönetimi, AI tasarım, yapay zekâ otomasyonları, ürün ve tanıtım web siteleri, otel web sitesi oluşturma, logo tasarımı ve otomasyon tasarımıyla ürün satış web sitesi geliştirme hizmetleri sunar. Çok dilli SEO odaklı çözümlerimizle aramalarda öne çıkmanızı sağlarız.',
    'seo.home.keywords': 'kktc web tasarım, kktc sosyal medya yönetimi, kktc ai tasarım, kktc yapay zeka otomasyon, ürün web sitesi, tanıtım web sitesi, otel web sitesi oluşturma, logo tasarımı, otomasyon tasarımı, ürün satış web sitesi, girne web tasarım, lefkoşa web tasarım, gazimağusa web tasarım, mağusa web tasarım',
