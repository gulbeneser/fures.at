...
const translations = {
  tr: {
    ...
    'seo.common.keywords': 'kuzey kıbrıs web tasarım, kıbrıs web tasarım ajansı, kıbrıs dijital ajans, gazimağusa web tasarım, lefkoşa web tasarım, kıbrıs yapay zeka otomasyon, kıbrıs sosyal medya yönetimi, kıbrıs seo ajansı, kktc web tasarım, kktc dijital ajans, kktc web tasarım ajansı',
    'seo.organization.description': 'Fures Tech, Gazimağusa merkezli çok dilli web tasarım, yapay zekâ otomasyon ve büyüme ajansıdır. KKTC web tasarım ajansı olarak Kuzey Kıbrıs ve çevre pazarlardaki oteller, turizm işletmeleri, e-ticaret markaları ve hizmet şirketleri için uçtan uca dijital çözümler tasarlıyoruz.',
    'seo.home.title': 'Fures Tech | Kuzey Kıbrıs Web Tasarım, Yapay Zekâ ve Sosyal Medya Ajansı',
    'seo.home.description': 'Fures Tech, Kuzey Kıbrıs ve Türkiye\'de işletmelere özel web tasarım, yapay zekâ otomasyonları, sosyal medya yönetimi ve veri odaklı büyüme hizmetleri sunar. KKTC web tasarım ajansı refleksiyle çok dilli SEO uyumlu projeler geliştirerek sizi aramalarda öne çıkarırız.',
    'seo.home.keywords': 'kuzey kıbrıs dijital ajans, kıbrıs sosyal medya ajansı, kıbrıs yapay zeka ajansı, kıbrıs seo danışmanlığı, gazimağusa reklam ajansı, kktc web tasarım, kktc dijital ajans',
    ...
    'seo.services.description': 'Fures Tech; web tasarım ve geliştirme, yapay zekâ otomasyonları, sosyal medya yönetimi, veri analitiği ve içerik üretimiyle KKTC dijital ajansı standartlarını Kıbrıs\'ta işletmenizi büyütmek için uygular.',
    'seo.services.keywords': 'kuzey kıbrıs web hizmetleri, kıbrıs otomasyon çözümleri, kıbrıs sosyal medya yönetimi, kıbrıs veri analitiği, kktc web tasarım ajansı',
    ...
    'mission.description': 'Geniş kapsamlı yapay zekâ otomasyonu ve zamansız tasarımla KKTC ve çevresindeki işletmeleri kendi kulvarlarında zirveye taşımak.',
    ...
    'services.web_design_desc': 'KKTC web tasarım ajansı yaklaşımıyla kullanıcı deneyimini ve iş büyümesini artıran modern, yüksek performanslı web siteleri tasarlıyor ve geliştiriyoruz',
    'services.ai_automation': 'Akıllı Otomasyon',
    'services.ai_automation_desc': 'Operasyonları kolaylaştırmak, maliyetleri azaltmak ve verimliliği artırmak için KKTC dijital ajans ekibimizin geliştirdiği yapay zeka destekli otomasyon çözümleri sunuyoruz.',
    'services.social_media': 'Sosyal Medya Yönetimi',
    'services.social_media_desc': 'Veriye dayalı sosyal medya stratejileri oluşturuyor ve çevrimiçi varlığınızı yönetiyoruz; KKTC markaları için etkileşimi ve marka bilinirliğini en üst düzeye çıkarıyoruz.',
